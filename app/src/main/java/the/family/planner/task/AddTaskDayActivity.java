...
public class AddTaskDayActivity extends AppCompatActivity  {
    ...
    private void timePick(EditText timetext){
        timePickerDialog = new TimePickerDialog(AddTaskDayActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    private void onClickAddTask() {
        ...
        Intent intent = new Intent(AddTaskDayActivity.this, DayViewActivity.class);
